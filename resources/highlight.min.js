...
;"object"==typeof exports&&"undefined"!=typeof module&&(module.exports=hljs);hljs.registerLanguage("python",(()=>{"use strict";function e(e){
...
begin:/^\.\.\.(?=[ ]|$)/}]}]})})());hljs.registerLanguage("sql",(()=>{"use strict";function e(e){
...
begin:/[-+*/=%^~]|&&?|\|\|?|!=?|<(?:=>?|<|>)?|>[>=]?/,relevance:0}]}}})());hljs.registerLanguage("vbnet",(()=>{"use strict";function e(e){
return e?"string"==typeof e?e:e.source:null}function n(...n){
...
contains:[c]}]}}})());hljs.registerLanguage("php",(()=>{"use strict";return e=>{const r={
className:"variable",
...
className:"variable.constant"},R,k,{match:/\$[(.]/}]}}})());hljs.registerLanguage("kotlin",(()=>{"use strict"
...
},e.C_LINE_COMMENT_MODE,e.C_BLOCK_COMMENT_MODE]},n,r]}}})());hljs.registerLanguage("perl",(()=>{"use strict";function e(e){
return e?"string"==typeof e?e:e.source:null}function n(...n){
return n.map((n=>e(n))).join("")}function t(...n){return"("+((e=>{
const n=e[e.length-1]
;return"object"==typeof n&&n.constructor===Object?(e.splice(e.length-1,1),n):{}
...
contains:p}}})());hljs.registerLanguage("r",(()=>{"use strict";function e(...e){return"("+((e=>{
const n=e[e.length-1]
;return"object"==typeof n&&n.constructor===Object?(e.splice(e.length-1,1),n):{}
...
contains:[{begin:/\\./}]}]}}})());hljs.registerLanguage("nginx",(()=>{"use strict";function e(e){
...
illegal:"[^\\s\\}\\{]"}}})());hljs.registerLanguage("php-template",(()=>{"use strict";return n=>({
...
starts:{end:/$/,contains:[t,l,r,i,c,a]}}]}}})());hljs.registerLanguage("rust",(()=>{"use strict";function e(...e){
...
name:"Plain text",aliases:["text","txt"],disableAutodetect:!0})})());hljs.registerLanguage("objectivec",(()=>{"use strict";return e=>{
...
relevance:0}]}}})());hljs.registerLanguage("apache",(()=>{"use strict";return e=>{const n={
...
end:/$/,keywords:{$pattern:/[\.\w]+/,keyword:".PHONY"}},r]}}})());hljs.registerLanguage("cpp",(()=>{"use strict";function e(e){
...
},e.C_LINE_COMMENT_MODE,e.C_BLOCK_COMMENT_MODE]},b]}}})());hljs.registerLanguage("scss",(()=>{"use strict"
...
},...B,..._,...M,I,P,...z,...q,U,V]}}})());hljs.registerLanguage("c",(()=>{"use strict";function e(e){
...
strings:i,keywords:u}}}})());hljs.registerLanguage("typescript",(()=>{"use strict"
...
name:"TypeScript",aliases:["ts","tsx"]}),m}})());hljs.registerLanguage("ruby",(()=>{"use strict";function e(e){
return n("(?=",e,")")}function n(...e){return e.map((e=>{
return(n=e)?"string"==typeof n?n:n.source:null;var n})).join("")}return a=>{
const i="([a-zA-Z_]\\w*[!?=]?|[-+~]@|<<|>>|=~|===?|<=>|[<>]=?|\\*\\*|[-/+%^&*~`|]|\\[\\]=?)",s={
...
aliases:["yml"],contains:b}}})());hljs.registerLanguage("diff",(()=>{"use strict";function e(...e){
return"("+((e=>{const n=e[e.length-1]
;return"object"==typeof n&&n.constructor===Object?(e.splice(e.length-1,1),n):{}
})(e).capture?"":"?:")+e.map((e=>{return(n=e)?"string"==typeof n?n:n.source:null
...
end:/$/}]})})());hljs.registerLanguage("less",(()=>{"use strict"
...
name:"Less",case_insensitive:!0,illegal:"[=>'/<($\"]",contains:c}}})());hljs.registerLanguage("css",(()=>{"use strict"
...
begin:"\\b("+e.join("|")+")\\b"}]};var s}})());hljs.registerLanguage("json",(()=>{"use strict";return e=>({name:"JSON",
...
begin:/\(/,end:/\)/,keywords:n,illegal:/["']/}]}]}}})());hljs.registerLanguage("lua",(()=>{"use strict";return e=>{
